 ...
 */
public class Simulation4 extends Application {

    private final Robot4 robot;
    ...
    public Simulation4(){
        ...
        robot = new Robot4(new double[]{300,100}, 40, target);
        root = new Pane();
    ...
    public void start(Stage primaryStage){
        ...
        primaryStage.setTitle("Simulation 4");
